...
@Suite struct PaginatedResponseTests {
    ...
    """
        ...
        #expect(firstBirthday?.birthday.year == 1982)
        #expect(firstBirthday?.birthday.month == 10)
        #expect(firstBirthday?.birthday.day == 28)
    ...
    @Test func testDecodeContactsResponse() throws {
        ...
        #expect(firstContact?.birthday?.year == 1982)
        #expect(firstContact?.birthday?.month == 10)
        #expect(firstContact?.birthday?.day == 28)
